...
echo "==================== Phase 0 - Launch production and analytics backend ======================"
...
echo "===================== Phase 1 - Status checks (check if server has finished running user data) ====================="
...
echo "Checking status of Mongodb server"
...
echo "================== Phase 1.5 - Database analytics ETL =============================="
